...
class Book(Base):
    ...
    def __str__(self):
        return f'{self.__tablename__}: {self.id} {self.title} {self.id_publisher}'
...
class Stock(Base):
    ...
    def __str__(self):
        return f'{self.__tablename__}: {self.id} {self.id_book} {self.id_shop}'
...
class Sale(Base):
    ...
    def __str__(self):
        return f'{self.__tablename__}: {self.id} {self.price} {self.date_sale} {self.id_stock} {self.count}'
